package com.kunai.cumlesql.sqlmodel;
...
import com.kunai.cumlesql.R;

import java.util.List;

public class QueryAdapter extends RecyclerView.Adapter<QueryAdapter.MyViewHolder>{

    List<MyQuery> messageList;

    public QueryAdapter(List<MyQuery> messageList) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int position) {
        MyQuery message = messageList.get(position);
        if (message.getSentBy().equals(MyQuery.SEND_BY_ME)){
